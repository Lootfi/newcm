...
const Lightbox = React.memo(() => {
  ...
  return (
    ...
    >
      <LoginModalWrapper>
        <LightboxWrapper>
          <Box className="row" flexBox={true} flexWrap={'wrap'}>
            <Box className="col tabCol">
              <Box>
                {/* MY JSX */}
                {/* 
                        ...
                        {pageNum == 1 && (
                          <div className={classNames('page', 'intro')}>
                            ...
                            <div className="field">
                              ...
                              <p>
                                Parce que votre carrière dure dans le temps,
                                votre accès durera à vie. Vous aurez toujours
                                accès a tous les contacts musicaux et contacts
                                médias sans aucune limite dans le temps.
                              </p>
                              <div className="slider-dots">
                                <div className="slider"></div>
                                <div
                          ...
                          <div className={classNames('page', 'intro', 'end')}>
                            <div className="field">
                              ...
                              <p>
                                ...
                                adipiscing elit. Vivamus et eros ligula.
                              </p>
                              <div className="form-container">
