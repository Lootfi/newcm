        ...
        var i = a(1),
            ...
            l = function (e) {
                ...
                for (var t in d.default)
                    if (
                        d.default.hasOwnProperty(t) &&
                        d.default[t].predict.test(a)
                    ) {
                        e.setAttribute(
                            "mask-pattern",
                            d.default[t].maskPattern
                        );
                ...
                e &&
                    (r
                        ? (e.classList.remove("error"),
                          e.classList.add("validcard"))
                        : (e.classList.add("error"),
                          e.classList.remove("validcard")));
            };
        (r.init = m),
            (r.defaults = c),
            (r.predictCard = l),
